<template>
    <div class="max-w-4xl flex items-center flex-wrap mx-auto my-32 lg:my-0 font-sans antialiased text-gray-900 leading-normal tracking-wider bg-cover h-full">
        ...
        <div class="w-full lg:w-2/5">
            ...
            <img src="https://mamaplus.md/sites/default/files/styles/650x365/public/2019-08/31.12.2017.2.jpg?itok=DBA-WH4_" class="rounded-none lg:rounded-lg shadow-2xl hidden lg:block">
